...
const srcFiles = [
  ...
  'repositories/RepurposingRepository.js', 'repositories/WeeklyPlanRepository.js',
  'WorkbookService.js', 'WorkflowSeed.js', 'Menu.js', 'Main.js',
].map(function (f) { return path.join(SRC, f); });

const testFiles = [
  'TestRunner.js', 'SchemaTests.js', 'IdTests.js', 'ValidationTests.js', 'RepositoryTests.js',
